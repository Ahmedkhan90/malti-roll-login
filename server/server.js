...
var { userModle, shopCartModel, sweetOrdersModel } = require("../server/dbconn/module");
var authRoutes = require("../server/routes/auth")
console.log(userModle, shopCartModel, sweetOrdersModel)

var { SERVER_SECRET } = require("../server/core/index");
...
app.use("/", express.static(path.resolve(path.join(__dirname, "web/bulid"))));
app.use('/', authRoutes)
